...
export const salesInvoicePositionColumnsConfig: (properties?: {
    ...
    },
    {
        ...
        field: 'salesInvoiceHeader.name',
        searchableField: '$salesInvoiceHeader.name$',
        sort: 'salesInvoiceHeader.name',
        translation: 'Name',
        isUnaccent: true,
    },
    {
