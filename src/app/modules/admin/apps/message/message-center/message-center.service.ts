...
export class MessageCenterService
{
    ...
    // selectedMessageChanged: BehaviorSubject<MessageInbox> = new BehaviorSubject(null);

    //private _message$: BehaviorSubject<MessageInbox> = new BehaviorSubject(null);
     ...
     * Getter for message
     */
    /* get message$(): Observable<MessageInbox>
    {
