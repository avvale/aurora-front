...
import { InboxDetailsComponent } from '@apps/notification/notification-manager/details/details.component';
import { InboxEmptyDetailsComponent } from '@apps/notification/notification-manager/empty-details/empty-details.component';
import { InboxListComponent } from '@apps/notification/notification-manager/list/list.component';
import { InboxComponent } from '@apps/notification/notification-manager/inbox.component';
import { MailboxService } from '@apps/notification/notification-manager/mailbox.service';
